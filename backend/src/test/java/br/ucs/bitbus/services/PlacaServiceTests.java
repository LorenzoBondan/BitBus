...
public class PlacaServiceTests {
    ...
    void setUp() {
        ...
        Placa object = Factory.createPlaca();
        PageImpl<Placa> page = new PageImpl<>(List.of(object));
    ...
    public void findAllShouldReturnPage() {
        ...
        Page<PlacaDTO> result = service.findAllByName(name, pageable);
        Assertions.assertNotNull(result);
    }

    @Test
    public void findByIdShouldReturnObjectWhenExistingId() {
        PlacaDTO result = service.findById(existingId);
        Assertions.assertNotNull(result);
    ...
    @Test
    public void insertShouldReturnPlacaDtoWhenValidData() {
        PlacaDTO PlacaDTO = Factory.createPlacaDTO();
        PlacaDTO result = service.insert(PlacaDTO);
        Assertions.assertNotNull(result);
        Assertions.assertEquals(PlacaDTO.getNome(), result.getNome());
    }

    @Test
    public void updateShouldReturnPlacaDtoWhenExistingId() {
        PlacaDTO PlacaDTO = Factory.createPlacaDTO();
        PlacaDTO result = service.update(existingId, PlacaDTO);
        Assertions.assertNotNull(result);
        Assertions.assertEquals(PlacaDTO.getNome(), result.getNome());
    }
    ...
    public void updateShouldThrowEntityNotFoundExceptionWhenNonExistingId() {
        Assertions.assertThrows(ResourceNotFoundException.class, () -> {
            PlacaDTO PlacaDTO = Factory.createPlacaDTO();
            service.update(nonExistingId, PlacaDTO);
        });
    }
